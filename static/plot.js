...
function init() {
    ...
    d3.csv("static/archive/top100_actors.csv").then(function (data) {
    let actors = data
    ...
    d3.csv("static/archive/top100_composers.csv").then( function (data) {
    var composers = data
    ...
    d3.csv("static/archive/top100_directors.csv").then(function (data) {
    var directors = data
    ...
    d3.csv("static/archive/alph_genres.csv").then (function(data) {
    var genres = data
  ...
  d3.csv("static/archive/avg_rev_vote.csv").then (function(data) {
  var ratings = data
